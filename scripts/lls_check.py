...
# python scripts/lls_check.py [LLS-PATH] [SCRIPTS-FOLDER] [LOG-OUTPUT-FOLDER-PATH] [LLS-CONFIGURATION-PATH]
...
def main():
    if len(sys.argv) != 5:
        print_lls("Wrong number of arguments passed to lls_check.py")
        return 1
