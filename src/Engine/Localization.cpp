...
bool Localization::initialize() {
    ...
    this->_localizationRaw = engine->resources()->event("global.txt").string_view();
...
void Localization::initializeSkillNames() {
    ...
    _skillDescRaw = engine->resources()->event("skilldes.txt").string_view();
...
void Localization::initializeClassNames() {
    ...
    this->_classDescRaw = engine->resources()->event("class.txt").string_view();
...
void Localization::initializeAttributeNames() {
    ...
    this->_attributeDescRaw = engine->resources()->event("stats.txt").string_view();
